...
const products = [
  {
    cat: "subtitle",
    title: "Keyboard",
    image: "https://woodmart.xtemos.com/keyboards/wp-content/uploads/sites/36/2026/04/kalam-unikorn-purple-pvd.jpeg.webp",
...
function ProductCard({ title, image, cat , price,rating,image2 }) {
  return (
    <div className="relative rounded-3xl h-[400px] w-[300px] shadow-xl overflow-hidden group">
      <div
